...
public class CalcPanel extends JPanel implements ActionListener {
	...
	public CalcPanel() {
		...
		bpow.setBounds(100, 50, 50, 50);
		bdiv.setBounds(154, 50, 50, 50);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (s.equals("1") || s.equals("2") || s.equals("3") || s.equals("4") || s.equals("5") || s.equals("6")
				|| s.equals("7") || s.equals("8") || s.equals("9") || s.equals("0") || s.equals(".")) {
			if (usingFirst) {
